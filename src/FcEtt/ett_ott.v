...
(* defns JAppsPath *)
Inductive AppsPath : const -> Apps -> tm -> roles -> Prop :=    (* defn AppsPath *)
 | AppsPath_AbsConst : forall (F:const) (Rs:roles) (A:tm),
      binds  F  ( (Cs A Rs) )   toplevel   ->
     AppsPath F  nil  (a_Fam F) Rs
 | AppsPath_Const : forall (F:const) (Rs:roles) (p a A:tm) (R1:role),
      binds  F  ( (Ax p a A R1 Rs) )   toplevel   ->
     AppsPath F  nil  (a_Fam F) Rs
 | AppsPath_App : forall (F:const) (R1:role) (Apps5:Apps) (a b':tm) (Rs:roles),
     lc_tm b' ->
     AppsPath F Apps5 a  ( R1 :: Rs )  ->
     AppsPath F  (  ( (A_Tm (Role R1)) :: Apps5 )  )   ( (a_App a (Role R1) b') )  Rs
 | AppsPath_IApp : forall (F:const) (Apps5:Apps) (a:tm) (Rs:roles),
     AppsPath F Apps5 a Rs ->
     AppsPath F  (  ( (A_Tm (Rho Irrel)) :: Apps5 )  )   ( (a_App a (Rho Irrel) a_Bullet) )  Rs
 | AppsPath_CApp : forall (F:const) (Apps5:Apps) (a:tm) (Rs:roles),
     AppsPath F Apps5 a Rs ->
     AppsPath F  (  ( A_Co :: Apps5 )  )   ( (a_CApp a g_Triv) )  Rs.
...
Inductive BranchTyping : context -> Apps -> role -> tm -> tm -> tm -> pattern_args -> tm -> tm -> tm -> Prop :=    (* defn BranchTyping *)
 ...
 | BranchTyping_PiRole : forall (L:vars) (G:context) (R:role) (Apps5:Apps) (a A1 b:tm) (pattern_args5:pattern_args) (A B C C':tm),
     ...
     BranchTyping G  (  ( (A_Tm (Role R)) :: Apps5 )  )  Nom a A1 b pattern_args5 (a_Pi Rel A B) (a_Pi Rel A C) C'
 | BranchTyping_PiRel : forall (L:vars) (G:context) (Apps5:Apps) (a A1 b:tm) (pattern_args5:pattern_args) (A B C C':tm),
     ...
     BranchTyping G  (  ( (A_Tm (Rho Rel)) :: Apps5 )  )  Nom a A1 b pattern_args5 (a_Pi Rel A B) (a_Pi Rel A C) C'
 | BranchTyping_PiIrrel : forall (L:vars) (G:context) (Apps5:Apps) (a A1 b:tm) (pattern_args5:pattern_args) (A B C C':tm),
     ...
     BranchTyping G  (  ( (A_Tm (Rho Irrel)) :: Apps5 )  )  Nom a A1 b pattern_args5 (a_Pi Irrel A B) (a_Pi Irrel A C) C'
